...
1. Open your RTSP server app (for example ScreenStream) and note the server endpoint. Important: If using ScreenStream make sure to enable device audio under audio settings.
